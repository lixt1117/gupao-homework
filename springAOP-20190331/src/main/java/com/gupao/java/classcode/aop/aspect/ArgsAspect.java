package com.gupao.java.classcode.aop.aspect;
...
public class ArgsAspect {
	...
	@Pointcut("execution(* com.gupao.java.classcode.aop.service..*(..))")
	public void aspect(){	}
	
	//配置前置通知,拦截返回值为com.gupaoedu.vip.model.Member的方法
	@Before("execution(com.gupao.java.classcode.model.Member com.gupao.java.classcode.aop.service..*(..))")
	public void beforeReturnUser(JoinPoint joinPoint){
		log.info("beforeReturnUser " + joinPoint);
	}

	//配置前置通知,拦截参数为com.gupaoedu.vip.model.Member的方法
	@Before("execution(* com.gupao.java.classcode.aop.service..*(com.gupao.java.classcode.model.Member))")
